Now I have a comprehensive understanding of the codebase. Let me create the updated CLAUDE.md with all the accurate information:
...
- `tests/` - Jest test suite (42 tests, 80%+ coverage threshold)
...
**Testing**: 42 Jest tests covering all schemas, helper functions, and edge cases
